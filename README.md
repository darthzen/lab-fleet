...
flowchart TD
    ...
    subgraph ai["04-09 — AI Stack (namespace: ai)"]
        ...
        MCP[09 MCP layer<br/>mcpo · k8s · github · docs-rag · jev]
    end
...
| 04 | Ollama (+ metrics/proxy exporter) — scaled to 0 while 26 runs | otwld ollama-helm | chart 1.75.0 (app 0.32.14-rc0) |
...
| 09 | MCP layer (mcpo, k8s/github MCP, docs-rag MCP, fossa-mcp, ollama-code, jev-mcp) | manifests + in-repo source | jev-mcp 0.1.2 (Harbor) |
